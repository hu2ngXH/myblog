                ...
                if (confirm("确定删除分类？")) {
                    if (count > 0)
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "<%=context %>/CategoryEditServlet",
                            data: {
                                "action": "delete",
                                "type": type,
                                "id": id
            ...
            <div class="row">
                ...
                <div id="addCty" class="col-md-3 col-xs-12">
                    ...
                    <div class="form-group">
                        <form action="<%=context %>/CategoryEditServlet?action=add" method="post">
                            <h4>类别名称：</h4>
                    ...
                    <form class="form-inline" action="#" method="POST">
                        <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger"
                                                onclick="deleteCategory(${maincategory.id },${maincategory.count },'main')">
                                            删除
                                        </button>
                            ...
                            <c:forEach items="${category }" var="subcategory">
                                <tr>
                                    <td>${subcategory.sCategoryName }</td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger"
                                                onclick="deleteCategory(${subcategory.sCategoryId },${subcategory.sub_count },'sub')">
                                            删除
                                        </button>
                                        <input type="text" class="form-control" name="main_id"
                                               value="${subcategory.mCategoryId }"
                                               style="display: none">
                                        <input type="text" class="form-control" name="sub_id"
                                               value="${subcategory.sCategoryId }"
                                               style="display: none">
                                    </td>
                                </tr>
                            </c:forEach>
                ...
                <div class="modal fade" id="mainModal" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="<%=context %>/CategoryEditServlet?action=update" method="post">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label class="control-label">类别名称:</label>
                                        <input type="text" class="form-control" name="maincategoryname"
                                               id="updatemainname">
                                    </div>
