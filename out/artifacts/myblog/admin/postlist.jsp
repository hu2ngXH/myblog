    ...
    <head>
        ...
        <script>
            ...
            function handlePaginationClick(new_page_index, pagination_container) {
                $("#postForm").attr("action", "<%=context %>/PostlistServlet?role=1&pageNum=" + (new_page_index + 1));
                $("#postForm").submit();
                return false;
            };
            $(function () {
            ...
            <div class="row">
                <div id="left-nav" class="col-md-2">
                    <div class="author-nav">
                        <img src="<%=context%>/img/favicon.ico" alt="个人头像">
                    </div>
                    <div class="main-nav">
                        <ul>
                            <a href="#">
                ...
                <div id="list" class="col-md-10 col-xs-12">
                    ...
                    <c:if test="${fn:length(result.dataList) gt 0 }">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><c:out value="${article.mCategoryName }"></c:out></td>
                                <td><c:out value="${article.sCategoryName }"></c:out></td>
                                <td><c:out value="${article.createdDate }"></c:out></td>
                                <td>
                                    <a href="<%=context %>/PostlistServlet?role=3&id=${article.id }">
                    ...
                    <div class="fiter col-md-4">
                        <form class="form-horizontal form-inline" action="<%=context %>/PostlistServlet?role=1"
